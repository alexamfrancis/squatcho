...
public struct Constants {
    ...
    static let rule1 = Rule(title: "The Hunt", text: "At the start time of the hunt, your first riddle will be revealed. Solve the riddle to find out where to go next. If you’re correct and your GPS location matches the right location, you will be prompted to take a team picture to unlock the next riddle. Once you solve all of the riddles, adventuring around SLO, the final riddle will give you the code to the treasure chest with $10,000. If you get there with the code first, it’s yours.")
    static let rule2 = Rule(title: "Teams", text: "It costs $20 flat fee for a team of up to 4 teammates. Fewer teammates means your portion is bigger, but less brain power for solving riddles. Once you've registered a team, you are in charge of inviting the smartest, quickest, and most fun of your friends to join your team. Or, join a friends team and help them towards victory.")
    static let rule3 = Rule(title: "Logistics", text: "The riddles may require a drive, hike, or another mode of transportation. None of the riddles will take you out of the bounds of the map. None of the riddles require paying more money (except maybe gas). If you haven’t solved a riddle after 2, we will give you a hint to help you out.")
    static let rule4 = Rule(title: "Disqualification", text: "Once the event starts, teams are locked. All team members must be in every team picture. If a teammate has to leave in the middle and misses a picture, that clue hasn’t been solved. Make sure all teammates are committed to be there that day, if you want to be eligible to win.")
